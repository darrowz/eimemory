...
TRANSITIONS: dict[str, frozenset[str]] = {
    ...
    "DEPLOY_INTENT": frozenset({"DEPLOYED_VERIFIED", "ROLLBACK_INTENT", "ABORTED_CANDIDATE_RESTORED", "RECOVERY_QUARANTINED"}),
    ...
    "ROLLBACK_INTENT": frozenset({"ROLLED_BACK_HEALTHY", "ABORTED_CANDIDATE_RESTORED", "RECOVERY_QUARANTINED"}),
}
