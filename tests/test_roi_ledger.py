...
def _append_record(runtime: Runtime, *, kind: str, title: str, meta: dict, content: dict | None = None) -> RecordEnvelope:
...
def test_roi_ledger_credits_active_rules_and_passing_eval_reports(tmp_path) -> None:
    ...
    assert report["roi_breakdown"]["counts"]["eval_pass_reports"] == 2
