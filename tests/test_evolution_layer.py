...
def test_openclaw_plugin_manifest_points_to_bridge_plugin() -> None:
    manifest_path = Path("integrations/openclaw/eimemory-bridge/openclaw.plugin.json")
    ...
    assert not Path("integrations/openclaw/openclaw.plugin.json").exists()
    ...
    assert package["peerDependencies"]["openclaw"] == ">=2026.7.1"
