...
- Add independent semantic quality gates for answer groups, returned precision, false recall, leakage and latency; explicit acceptance never replaces natural production evidence or strict release state.
- Add resource-limited reranker provisioning and optional runtime configuration without changing upstream OpenClaw or enabling unvalidated production inference.
